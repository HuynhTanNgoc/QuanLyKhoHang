function Product (Id, ProductName, Category, PriceInput) {
    this.Id= Id;
...
function addProduct() {
    ...
    if (productPrice.indexOf('e') !== -1 || productPrice === "" ||
        ...
        if (flag) {
            ...
            ProductList[ProductIndex].Category = productCategory;
